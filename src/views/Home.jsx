...
const Movies = () => {
    ...
    async function getMovies(){
        const res = await axios.get(`https://mp2-api-json-server.onrender.com/movies?_page=${page}&_limit=${limit}`) //default sorted by popularity
        // const res = await axios.get(`http://localhost:3000/movies?_page=${page}&_limit=${limit}&_sort=release_date&_order=desc`) //sorted by release date, can also be used for upcoming
