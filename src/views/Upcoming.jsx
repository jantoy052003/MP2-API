...
const Upcoming = () => {
    ...
    async function getMovies(){
        const res = await axios.get(`http://localhost:3000/movies?_start=0&_limit=9&_sort=release_date&_order=desc`) //sorted by release date, can also be used for upcoming
